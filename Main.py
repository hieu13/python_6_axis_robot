...
class ROBOT_GRAPHIC( OpenGLFrame ):
    ...
    def redraw(self):
       ...
       # self.robot_state.joint_state[6].set_th((2 * np.pi / 200) * app.val7.get())###' WANT TO USE 7 AXIS please fix this with kinematics.py   HIEU
        self.spin()
        self.paintGL()
        #################
...
#        self.val7.set((200 / (2 * np.pi)) * self.robot_state_.joint_state[6].th)###' WANT TO USE 7 AXIS please fix this with kinematics.py  HIEU
    ...
    def create_widget(self):
        ...
        ##
        self.label_robotset = tk.LabelFrame(self.tab0, text="KINEMATIC_forward", labelanchor="nw", width=500, height=140)
        self.label_robotset.propagate(False)
        self.label_robotset.place(x=0, y=510)
        lbl_J1 = tk.Label(self.label_robotset, text="J1")
        lbl_J1.place(x=0, y=20)
        lbl_J2 = tk.Label(self.label_robotset, text="J2")
        lbl_J2.place(x=0, y=50)
        lbl_J3 = tk.Label(self.label_robotset, text="J3")
        lbl_J3.place(x=0, y=80)
        lbl_J4 = tk.Label(self.label_robotset, text="J4")
        lbl_J4.place(x=250, y=20)
        lbl_J5 = tk.Label(self.label_robotset, text="J5")
        lbl_J5.place(x=250, y=50)
        lbl_J6 = tk.Label(self.label_robotset, text="J6")
        lbl_J6.place(x=250, y=80)
        ...
        scale_rb1.place(x=20, y=10)
        scale_rb2.place(x=20, y=40)
        scale_rb3.place(x=20, y=70)
        scale_rb4.place(x=270, y=10)
        scale_rb5.place(x=270, y=40)
        scale_rb6.place(x=270, y=70)
    ...
    def create_robot_program(self):
        ...
        self.tab10.progView = Listbox(progframe, exportselection=0, width=77, height=18, yscrollcommand=self.scrollbar.set)
    ...
    def teachInsertBelSelected(self):
        ...
        if (movetype == "OFF J"):
            ...
            newPos = movetype + " [*] X " + self.XcurPos + " Y " + self.YcurPos + " Z " + self.ZcurPos + " Rz " + self.RzcurPos + " Ry " + self.RycurPos + " Rx " + self.RxcurPos + " J7 " + str(self.J7PosCur) + " J8 " + str(self.J8PosCur) + " J9 " + str(
        ...
        if (movetype == "Move Vis"):
            ...
            movetype = movetype + " [ PR: " + str(self.SavePosEntryField.get()) + " ]"
            newPos = movetype + " [*]" + " J7 " + str(self.J7PosCur) + " J8 " + str(self.J8PosCur) + " J9 " + str(self.J9PosCur) + " " + self.speedPrefix + " " + self.Speed + " Ac " + self.ACCspd + " Dc " + self.DECspd + " Rm " + self.ACCramp + " $ " + self.WC
            self.tab10.progView.insert(selRow, bytes(newPos + '\n', 'utf-8'))
            self.tab10.progView.selection_clear(0, END)
            self.tab10.progView.select_set(selRow)
            items = self.tab10.progView.get(0, END)
            ...
            newPos = movetype + " [*] J1 " + self.J1AngCur + " J2 " + self.J2AngCur + " J3 " + self.J3AngCur + " J4 " + self.J4AngCur + " J5 " + self.J5AngCur + " J6 " + self.J6AngCur + " J7 " + str(self.J7PosCur) + " J8 " + str(self.J8PosCur) + " J9 " + str(
                self.J9PosCur) + " " + self.speedPrefix + " " + self.Speed + " Ac " + self.ACCspd + " Dc " + self.DECspd + " Rm " + self.ACCramp + " $ " + self.WC
            self.tab10.progView.insert(selRow, bytes(newPos + '\n', 'utf-8'))
            self.tab10.progView.selection_clear(0, END)
            self.tab10.progView.select_set(selRow)
    ...
    def create_robot_widget(self):
        ...
        self.label_robot_check = tk.LabelFrame(self.tab1_rb, text="KINEMATIC_forward", labelanchor="nw", width=150, height=140)
    ...
    def calRobotJ1(self):
        command = "LLA1B0C0D0E0F0G0H0I0" + "J" + str(self.J1calOff) + "K" + str(self.J2calOff) + "L" + str(self.J3calOff) + "M" + str(self.J4calOff) + "N" + str(self.J5calOff) + "O" + str(self.J6calOff) + "P" + str(self.J7calOff) + "Q" + str(self.J8calOff) + "R" + str(
            self.J9calOff) + "\n"
        self.ser.write(command.encode())
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        ...
        pickle.dump(value, open("ErrorLog", "wb"))
    def calRobotJ2(self):
        command = "LLA0B1C0D0E0F0G0H0I0" + "J" + str(self.J1calOff) + "K" + str(self.J2calOff) + "L" + str(self.J3calOff) + "M" + str(self.J4calOff) + "N" + str(self.J5calOff) + "O" + str(self.J6calOff) + "P" + str(self.J7calOff) + "Q" + str(self.J8calOff) + "R" + str(
            self.J9calOff) + "\n"
        self.ser.write(command.encode())
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        ...
        pickle.dump(value, open("ErrorLog", "wb"))
    def calRobotJ3(self):
        command = "LLA0B0C1D0E0F0G0H0I0" + "J" + str(self.J1calOff) + "K" + str(self.J2calOff) + "L" + str(self.J3calOff) + "M" + str(self.J4calOff) + "N" + str(self.J5calOff) + "O" + str(self.J6calOff) + "P" + str(self.J7calOff) + "Q" + str(self.J8calOff) + "R" + str(
            self.J9calOff) + "\n"
        self.ser.write(command.encode())
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        ...
        pickle.dump(value, open("ErrorLog", "wb"))
    def calRobotJ4(self):
        command = "LLA0B0C0D1E0F0G0H0I0" + "J" + str(self.J1calOff) + "K" + str(self.J2calOff) + "L" + str(self.J3calOff) + "M" + str(self.J4calOff) + "N" + str(self.J5calOff) + "O" + str(self.J6calOff) + "P" + str(self.J7calOff) + "Q" + str(self.J8calOff) + "R" + str(
            self.J9calOff) + "\n"
        self.ser.write(command.encode())
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        ...
        pickle.dump(value, open("ErrorLog", "wb"))
    def calRobotJ5(self):
        command = "LLA0B0C0D0E1F0G0H0I0" + "J" + str(self.J1calOff) + "K" + str(self.J2calOff) + "L" + str(self.J3calOff) + "M" + str(self.J4calOff) + "N" + str(self.J5calOff) + "O" + str(self.J6calOff) + "P" + str(self.J7calOff) + "Q" + str(self.J8calOff) + "R" + str(
            self.J9calOff) + "\n"
        self.ser.write(command.encode())
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        ...
        pickle.dump(value, open("ErrorLog", "wb"))
    def calRobotJ6(self):
        command = "LLA0B0C0D0E0F1G0H0I0" + "J" + str(self.J1calOff) + "K" + str(self.J2calOff) + "L" + str(self.J3calOff) + "M" + str(self.J4calOff) + "N" + str(self.J5calOff) + "O" + str(self.J6calOff) + "P" + str(self.J7calOff) + "Q" + str(self.J8calOff) + "R" + str(
            self.J9calOff) + "\n"
        self.ser.write(command.encode())
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        ...
        pickle.dump(value, open("ErrorLog", "wb"))
    def calRobotJ7(self):
        command = "LLA0B0C0D0E0F0G1H0I0" + "J" + str(self.J1calOff) + "K" + str(self.J2calOff) + "L" + str(self.J3calOff) + "M" + str(self.J4calOff) + "N" + str(self.J5calOff) + "O" + str(self.J6calOff) + "P" + str(self.J7calOff) + "Q" + str(self.J8calOff) + "R" + str(
            self.J9calOff) + "\n"
        self.ser.write(command.encode())
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        ...
        pickle.dump(value, open("ErrorLog", "wb"))
    def calRobotJ8(self):
        command = "LLA0B0C0D0E0F0G0H1I0" + "J" + str(self.J1calOff) + "K" + str(self.J2calOff) + "L" + str(self.J3calOff) + "M" + str(self.J4calOff) + "N" + str(self.J5calOff) + "O" + str(self.J6calOff) + "P" + str(self.J7calOff) + "Q" + str(self.J8calOff) + "R" + str(
            self.J9calOff) + "\n"
        self.ser.write(command.encode())
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        ...
        pickle.dump(value, open("ErrorLog", "wb"))
    def calRobotJ9(self):
        command = "LLA0B0C0D0E0F0G0H0I1" + "J" + str(self.J1calOff) + "K" + str(self.J2calOff) + "L" + str(self.J3calOff) + "M" + str(self.J4calOff) + "N" + str(self.J5calOff) + "O" + str(self.J6calOff) + "P" + str(self.J7calOff) + "Q" + str(self.J8calOff) + "R" + str(
            self.J9calOff) + "\n"
        self.ser.write(command.encode())
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
    ...
    def calRobotAll(self):
        ##### STAGE 1 ########
        command = "LL" + "A" + str(self.J1CalStatVal) + "B" + str(self.J2CalStatVal) + "C" + str(self.J3CalStatVal) + "D" + str(self.J4CalStatVal) + "E" + str(self.J5CalStatVal) + "F" + str(self.J6CalStatVal) + "G" + str(self.J7CalStatVal) + "H" + str(
            self.J8CalStatVal) + "I" + str(
            self.J9CalStatVal) + "J" + str(self.J1calOff) + "K" + str(self.J2calOff) + "L" + str(self.J3calOff) + "M" + str(self.J4calOff) + "N" + str(self.J5calOff) + "O" + str(self.J6calOff) + "P" + str(self.J7calOff) + "Q" + str(self.J8calOff) + "R" + str(self.J9calOff) + "\n"
        self.ser.write(command.encode())
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        self.ser.flushInput()
        ...
        if (CalStatVal2 > 0):
            command = "LL" + "A" + str(self.J1CalStatVal2) + "B" + str(self.J2CalStatVal2) + "C" + str(self.J3CalStatVal2) + "D" + str(self.J4CalStatVal2) + "E" + str(self.J5CalStatVal2) + "F" + str(self.J6CalStatVal2) + "G" + str(self.J7CalStatVal2) + "H" + str(
                self.J8CalStatVal2) + "I" + str(self.J9CalStatVal2) + "J" + str(self.J1calOff) + "K" + str(self.J2calOff) + "L" + str(self.J3calOff) + "M" + str(self.J4calOff) + "N" + str(self.J5calOff) + "O" + str(self.J6calOff) + "P" + str(self.J7calOff) + "Q" + str(
    ...
    def robot_tab_1_widget(self):
        ...
        ###########################
        self.KINEMATIC_TABLE_SIM_group = tk.LabelFrame(self.tab1_rb, text="KINEMATIC SIMULATOR TABLE", labelanchor="nw", width=300, height=200)
        self.KINEMATIC_TABLE_SIM_group.propagate(False)
        self.KINEMATIC_TABLE_SIM_group.place(x=530, y=175)

        J1DHparamLab = Label(self.KINEMATIC_TABLE_SIM_group, font=("Arial", 8), text="J1")
        J1DHparamLab.place(x=600 - 600, y=45 - 20)
        J1DHparamLab = Label(self.KINEMATIC_TABLE_SIM_group, font=("Arial", 8), text="J2")
        J1DHparamLab.place(x=600 - 600, y=70 - 20)
        J1DHparamLab = Label(self.KINEMATIC_TABLE_SIM_group, font=("Arial", 8), text="J3")
        J1DHparamLab.place(x=600 - 600, y=95 - 20)
        J1DHparamLab = Label(self.KINEMATIC_TABLE_SIM_group, font=("Arial", 8), text="J4")
        J1DHparamLab.place(x=600 - 600, y=120 - 20)
        J1DHparamLab = Label(self.KINEMATIC_TABLE_SIM_group, font=("Arial", 8), text="J5")
        J1DHparamLab.place(x=600 - 600, y=145 - 20)
        J1DHparamLab = Label(self.KINEMATIC_TABLE_SIM_group, font=("Arial", 8), text="J6")
        J1DHparamLab.place(x=600 - 600, y=170 - 20)

        ΘDHparamLab = Label(self.KINEMATIC_TABLE_SIM_group, font=("Arial", 8), text="DH-Θ")
        ΘDHparamLab.place(x=645 - 600, y=20 - 20)
        αDHparamLab = Label(self.KINEMATIC_TABLE_SIM_group, font=("Arial", 8), text="DH-α")
        αDHparamLab.place(x=700 - 600, y=20 - 20)
        dDHparamLab = Label(self.KINEMATIC_TABLE_SIM_group, font=("Arial", 8), text="DH-d")
        dDHparamLab.place(x=755 - 600, y=20 - 20)
        aDHparamLab = Label(self.KINEMATIC_TABLE_SIM_group, font=("Arial", 8), text="DH-a")
        aDHparamLab.place(x=810 - 600, y=20 - 20)

        self.J1ΘEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J1ΘEntryField_sim.place(x=630 - 600, y=45 - 20)
        self.J2ΘEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J2ΘEntryField_sim.place(x=630 - 600, y=70 - 20)
        self.J3ΘEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J3ΘEntryField_sim.place(x=630 - 600, y=95 - 20)
        self.J4ΘEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J4ΘEntryField_sim.place(x=630 - 600, y=120 - 20)
        self.J5ΘEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J5ΘEntryField_sim.place(x=630 - 600, y=145 - 20)
        self.J6ΘEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J6ΘEntryField_sim.place(x=630 - 600, y=170 - 20)

        self.J1αEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J1αEntryField_sim.place(x=685 - 600, y=45 - 20)
        self.J2αEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J2αEntryField_sim.place(x=685 - 600, y=70 - 20)
        self.J3αEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J3αEntryField_sim.place(x=685 - 600, y=95 - 20)
        self.J4αEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J4αEntryField_sim.place(x=685 - 600, y=120 - 20)
        self.J5αEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J5αEntryField_sim.place(x=685 - 600, y=145 - 20)
        self.J6αEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J6αEntryField_sim.place(x=685 - 600, y=170 - 20)

        self.J1dEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J1dEntryField_sim.place(x=740 - 600, y=45 - 20)
        self.J2dEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J2dEntryField_sim.place(x=740 - 600, y=70 - 20)
        self.J3dEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J3dEntryField_sim.place(x=740 - 600, y=95 - 20)
        self.J4dEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J4dEntryField_sim.place(x=740 - 600, y=120 - 20)
        self.J5dEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J5dEntryField_sim.place(x=740 - 600, y=145 - 20)
        self.J6dEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J6dEntryField_sim.place(x=740 - 600, y=170 - 20)

        self.J1aEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J1aEntryField_sim.place(x=795 - 600, y=45 - 20)
        self.J2aEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J2aEntryField_sim.place(x=795 - 600, y=70 - 20)
        self.J3aEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J3aEntryField_sim.place(x=795 - 600, y=95 - 20)
        self.J4aEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J4aEntryField_sim.place(x=795 - 600, y=120 - 20)
        self.J5aEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J5aEntryField_sim.place(x=795 - 600, y=145 - 20)
        self.J6aEntryField_sim = Entry(self.KINEMATIC_TABLE_SIM_group, width=8, justify="center")
        self.J6aEntryField_sim.place(x=795 - 600, y=170 - 20)
        ###########################
    ...
    def robot_Cam_Search_widget(self):
        ...
        video_frame = Frame(self.tab9, width=640, height=460)
        video_frame.place(x=0, y=200)
        ...
        self.VisZoomSlide.place(x=75, y=95-10)
        self.VisZoomSlide.set(50)

        VisZoomLab = Label(self.tab9, text="Zoom")
        VisZoomLab.place(x=75, y=115-10)
        ...
        self.VisBrightSlide.place(x=75, y=130-10)

        VisBrightLab = Label(self.tab9, text="Brightness")
        VisBrightLab.place(x=75, y=150-10)
        ...
        VisBacColorLab.place(x=390, y=120+5)
    ...
    def sendPos(self):
        command = "SP" + "A" + str(self.J1AngCur) + "B" + str(self.J2AngCur) + "C" + str(self.J3AngCur) + "D" + str(self.J4AngCur) + "E" + str(self.J5AngCur) + "F" + str(self.J6AngCur) + "G" + str(self.J7PosCur) + "H" + str(self.J8PosCur) + "I" + str(self.J9PosCur) + "\n"
        self.ser.write(command.encode())
        self.ser.flushInput()
        time.sleep(.1)
        response = self.ser.read()
    ...
    def calExtAxis(self):
        ...
        command = "CE" + "A" + str(self.J7PosLim) + "B" + str(self.J7rotation) + "C" + str(self.J7steps) + "D" + str(self.J8PosLim) + "E" + str(self.J8rotation) + "F" + str(self.J8steps) + "G" + str(self.J9PosLim) + "H" + str(self.J9rotation) + "I" + str(self.J9steps) + "\n"
        self.ser.write(command.encode())
        self.ser.flushInput()
        time.sleep(.1)
        response = self.ser.read()
    ...
    def J1jogNeg(self,value):
        ...
        self.ACCramp = self.ACCrampField.get()
        self.LoopMode = str(self.J1OpenLoopStat.get()) + str(self.J2OpenLoopStat.get()) + str(self.J3OpenLoopStat.get()) + str(self.J4OpenLoopStat.get()) + str(self.J5OpenLoopStat.get()) + str(self.J6OpenLoopStat.get())
        command = "RJ" + "A" + str(float(self.J1AngCur) - value) + "B" + self.J2AngCur + "C" + self.J3AngCur + "D" + self.J4AngCur + "E" + self.J5AngCur + "F" + self.J6AngCur + "J7" + str(self.J7PosCur) + "J8" + str(self.J8PosCur) + "J9" + str(
    ...
    def J2jogNeg(self,value):
        ...
        self.ACCramp = self.ACCrampField.get()
        self.LoopMode = str(self.J1OpenLoopStat.get()) + str(self.J2OpenLoopStat.get()) + str(self.J3OpenLoopStat.get()) + str(self.J4OpenLoopStat.get()) + str(self.J5OpenLoopStat.get()) + str(self.J6OpenLoopStat.get())
        command = "RJ" + "A" + self.J1AngCur + "B" + str(float(self.J2AngCur) - value) + "C" + self.J3AngCur + "D" + self.J4AngCur + "E" + self.J5AngCur + "F" + self.J6AngCur + "J7" + str(self.J7PosCur) + "J8" + str(self.J8PosCur) + "J9" + str(
            self.J9PosCur) + self.speedPrefix + self.Speed + "Ac" + self.ACCspd + "Dc" + self.DECspd + "Rm" + self.ACCramp + "W" + self.WC + "Lm" + self.LoopMode + "\n"
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        self.ser.write(command.encode())
    ...
    def J3jogNeg(self,value):
        ...
        self.ACCramp = self.ACCrampField.get()
        self.LoopMode = str(self.J1OpenLoopStat.get()) + str(self.J2OpenLoopStat.get()) + str(self.J3OpenLoopStat.get()) + str(self.J4OpenLoopStat.get()) + str(self.J5OpenLoopStat.get()) + str(self.J6OpenLoopStat.get())
        command = "RJ" + "A" + self.J1AngCur + "B" + self.J2AngCur + "C" + str(float(self.J3AngCur) - value) + "D" + self.J4AngCur + "E" + self.J5AngCur + "F" + self.J6AngCur + "J7" + str(self.J7PosCur) + "J8" + str(self.J8PosCur) + "J9" + str(
            self.J9PosCur) + self.speedPrefix + self.Speed + "Ac" + self.ACCspd + "Dc" + self.DECspd + "Rm" + self.ACCramp + "W" + self.WC + "Lm" + self.LoopMode + "\n"
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        self.ser.write(command.encode())
    ...
    def J4jogNeg(self,value):
        ...
        self.ACCramp = self.ACCrampField.get()
        self.LoopMode = str(self.J1OpenLoopStat.get()) + str(self.J2OpenLoopStat.get()) + str(self.J3OpenLoopStat.get()) + str(self.J4OpenLoopStat.get()) + str(self.J5OpenLoopStat.get()) + str(self.J6OpenLoopStat.get())
        command = "RJ" + "A" + self.J1AngCur + "B" + self.J2AngCur + "C" + self.J3AngCur + "D" + str(float(self.J4AngCur) - value) + "E" + self.J5AngCur + "F" + self.J6AngCur + "J7" + str(self.J7PosCur) + "J8" + str(self.J8PosCur) + "J9" + str(
            self.J9PosCur) + self.speedPrefix + self.Speed + "Ac" + self.ACCspd + "Dc" + self.DECspd + "Rm" + self.ACCramp + "W" + self.WC + "Lm" + self.LoopMode + "\n"
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        self.ser.write(command.encode())
    ...
    def J5jogNeg(self,value):
        ...
        self.ACCramp = self.ACCrampField.get()
        self.LoopMode = str(self.J1OpenLoopStat.get()) + str(self.J2OpenLoopStat.get()) + str(self.J3OpenLoopStat.get()) + str(self.J4OpenLoopStat.get()) + str(self.J5OpenLoopStat.get()) + str(self.J6OpenLoopStat.get())
        command = "RJ" + "A" + self.J1AngCur + "B" + self.J2AngCur + "C" + self.J3AngCur + "D" + self.J4AngCur + "E" + str(float(self.J5AngCur) - value) + "F" + self.J6AngCur + "J7" + str(self.J7PosCur) + "J8" + str(self.J8PosCur) + "J9" + str(
            self.J9PosCur) + self.speedPrefix + self.Speed + "Ac" + self.ACCspd + "Dc" + self.DECspd + "Rm" + self.ACCramp + "W" + self.WC + "Lm" + self.LoopMode + "\n"
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
        self.ser.write(command.encode())
    ...
    def J6jogNeg(self,value):
        ...
        self.ACCramp = self.ACCrampField.get()
        self.LoopMode = str(self.J1OpenLoopStat.get()) + str(self.J2OpenLoopStat.get()) + str(self.J3OpenLoopStat.get()) + str(self.J4OpenLoopStat.get()) + str(self.J5OpenLoopStat.get()) + str(self.J6OpenLoopStat.get())
        command = "RJ" + "A" + self.J1AngCur + "B" + self.J2AngCur + "C" + self.J3AngCur + "D" + self.J4AngCur + "E" + self.J5AngCur + "F" + str(float(self.J6AngCur) - value) + "J7" + str(self.J7PosCur) + "J8" + str(self.J8PosCur) + "J9" + str(
            self.J9PosCur) + self.speedPrefix + self.Speed + "Ac" + self.ACCspd + "Dc" + self.DECspd + "Rm" + self.ACCramp + "W" + self.WC + "Lm" + self.LoopMode + "\n"
        self.ser.write(command.encode())
        self.cmdSentEntryField.delete(0, 'end')
        self.cmdSentEntryField.insert(0, command)
